...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-desktop-notifications': { kind: 'none', reason: 'Browser-side toggle capsule persisting a human preference in localStorage; registers nothing model-facing.' },
